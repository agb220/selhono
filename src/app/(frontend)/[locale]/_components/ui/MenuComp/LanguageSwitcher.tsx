    ...
    <div className="pl-6 flex items-center">
      <DropdownMenu.Root modal={false}>
        <DropdownMenu.Trigger
          disabled={isPending}
          className="flex items-center gap-1.5 link hover:text-gold-300 transition-colors uppercase outline-none select-none cursor-pointer group disabled:opacity-50"
        >
          {currentLocale}
          <DropDownSvg
